...
export const Routes: AppRoute[] = [
  ...
  { path: "accounts", title: "Admin | Accounts", data: { alias: "admin-accounts" }, loadComponent: () => import("src/app/accounts/components/pages/index/index.component").then(m => m.IndexComponent) },
];
